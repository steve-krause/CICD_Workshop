...
export class PipelineCdkStack extends Stack {
  constructor(scope: Construct, id: string, props: ConsumerProps) {
    ...
    const signerARNParameter = new ssm.StringParameter(this, 'SignerARNParam', {
      ...
      stringValue: 'arn:aws:signer:us-east-2:832356551044:/signing-profiles/ecr_signing_profile',
    });
    ...
    pipeline.addStage({
      ...
      actions: [
        new codepipeline_actions.CodeStarConnectionsSourceAction({
          ...
          output: sourceOutput,
          branch: 'main',
          connectionArn: 'arn:aws:codeconnections:us-east-2:832356551044:connection/bd9f1156-8bed-49f7-ab20-5fa81d0f346f',
        }),
      ],
    });
